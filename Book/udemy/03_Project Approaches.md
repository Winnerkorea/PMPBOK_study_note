...
![PMBOK 8판 프로젝트 단계와 페이즈 게이트 한국어판](images/03_project_approaches/pmbok8-phase-gate-decisions-ko.png)

*PMBOK® Guide 8th Edition, The Standard for Project Management, p. 58. 한국어 학습용 재구성.*
...
![PMBOK 8판 시간에 따른 위험과 변경 비용 한국어판](images/03_project_approaches/pmbok8-figure-4-1-variables-over-time-ko.png)

*PMBOK® Guide 8th Edition, Figure 4-1, p. 59. 한국어 학습용 재구성.*
...
![PMBOK 8판 개발 접근 방식 스펙트럼 한국어판](images/03_project_approaches/pmbok8-figure-4-2-development-approaches-ko.png)

*PMBOK® Guide 8th Edition, Figure 4-2, p. 60. 한국어 학습용 재구성.*
...
![PMBOK 8판 예측형과 적응형의 제약 조건 선택 한국어판](images/03_project_approaches/pmbok8-figure-4-3-constraint-options-ko.png)

*PMBOK® Guide 8th Edition, Figure 4-3, p. 61. 한국어 학습용 재구성.*
...
![PMBOK 8판 예측형 수명주기와 점진적 전달 한국어판](images/03_project_approaches/pmbok8-figures-4-4-4-5-predictive-incremental-ko.png)

*PMBOK® Guide 8th Edition, Figures 4-4 and 4-5, p. 62. 한국어 학습용 재구성.*
...
![PMBOK 8판 적응형 개발 수명주기 한국어판](images/03_project_approaches/pmbok8-figure-4-6-adaptive-life-cycle-ko.png)

*PMBOK® Guide 8th Edition, Figure 4-6, p. 63. 한국어 학습용 재구성.*
...
![PMBOK 8판 하이브리드 접근 방식 패턴 한국어판](images/03_project_approaches/pmbok8-figures-4-9-4-10-hybrid-patterns-ko.png)

*PMBOK® Guide 8th Edition, Figures 4-9 and 4-10, p. 66. 한국어 학습용 재구성.*
...
#### 참고 자료: PMBOK 8판의 40개 프로세스

> **PMBOK 8판에서는 어떻게 설명하는가?**
>
> PMBOK 8판은 7개 성과 도메인에서 수행되는 활동의 기본 메커니즘을 설명하기 위해 **40개 프로세스**를 제시합니다. 각 프로세스에는 입력물, 도구 및 기법, 산출물의 예시가 포함됩니다. 다만 이 프로세스와 목록은 다양한 프로젝트 환경에 적용할 수 있도록 만든 **예시적(illustrative) 설명**이며, 모든 항목을 반드시 동일한 순서로 적용해야 하는 처방적 프레임워크나 방법론은 아닙니다. 프로젝트의 특성과 개발 접근 방식에 맞게 테일러링해야 합니다.
>
> 7개 성과 도메인은 프로젝트 수명주기 전체에서 동시에 작동하고 서로 중첩됩니다. 아래 표는 이러한 프로세스를 착수, 계획, 실행, 모니터링 및 통제, 종료의 5개 포커스 영역에 매핑한 것입니다.

| 성과 도메인 | 착수 | 계획 | 실행 | 모니터링 및 통제 | 종료 | 합계 |
|---|---|---|---|---|---|---:|
| **거버넌스** | 프로젝트 또는 단계 착수 | 프로젝트 계획 통합 및 정렬<br>조달 전략 계획 | 프로젝트 실행 관리<br>품질 보증 관리<br>프로젝트 지식 관리 | 프로젝트 성과 모니터링 및 통제<br>변경 평가 및 실행 | 프로젝트 또는 단계 종료 | **9** |
| **범위** | - | 범위 관리 계획<br>요구사항 도출 및 분석<br>범위 정의<br>범위 구조 개발 | - | 범위 모니터링 및 통제<br>범위 검증 | - | **6** |
| **일정** | - | 일정 관리 계획<br>일정 개발 | - | 일정 모니터링 및 통제 | - | **3** |
| **재무** | - | 재무 관리 계획<br>원가 추정<br>예산 개발 | - | 재무 모니터링 및 통제 | - | **4** |
| **이해관계자** | 이해관계자 식별<br>의사소통 관리 계획 | 이해관계자 참여 계획 | 이해관계자 참여 관리<br>의사소통 관리 | 이해관계자 참여 모니터링<br>의사소통 모니터링 | - | **7** |
| **리소스** | - | 리소스 관리 계획<br>리소스 추정 | 리소스 확보<br>팀 리드 | 리소싱 모니터링 및 통제 | - | **5** |
| **위험** | - | 위험 관리 계획<br>위험 식별<br>위험 분석 수행<br>위험 대응 계획 | 위험 대응 실행 | 위험 모니터링 | - | **6** |
| **포커스 영역별 합계** | **3** | **18** | **8** | **10** | **1** | **40** |

> **시험 학습 포인트**
>
> - 40개 프로세스는 **7개 성과 도메인**과 **5개 포커스 영역**을 연결합니다.
> - 포커스 영역은 프로젝트 단계가 아니며, 실제 프로젝트에서는 중첩되거나 반복될 수 있습니다.
> - 프로세스는 적용을 강제하는 체크리스트가 아니라 프로젝트 상황에 맞게 선택·조정하는 기술적 참고 체계입니다.
> - PMBOK 8판의 분포는 **착수 3 / 계획 18 / 실행 8 / 모니터링 및 통제 10 / 종료 1**입니다.

*출처: PMBOK® Guide 8th Edition, A Guide to the Project Management Body of Knowledge, Section 2, pp. 8-9, Table 2-1.*
...
![PMBOK 8판 포커스 영역과 프로젝트 경계 한국어판](images/03_project_approaches/pmbok8-figure-4-12-project-boundaries-ko.png)

*PMBOK® Guide 8th Edition, Figure 4-12, p. 71. 한국어 학습용 재구성.*
...
![PMBOK 8판 예측형 포커스 영역 상호작용 한국어판](images/03_project_approaches/pmbok8-figure-4-13-predictive-focus-areas-ko.png)

*PMBOK® Guide 8th Edition, Figure 4-13, p. 73. 한국어 학습용 재구성.*

![PMBOK 8판 적응형 포커스 영역 상호작용 한국어판](images/03_project_approaches/pmbok8-figure-4-14-adaptive-focus-areas-ko.png)

*PMBOK® Guide 8th Edition, Figure 4-14, p. 74. 한국어 학습용 재구성.*
...
![PMBOK 8판 포커스 영역과 성과 도메인 매핑 한국어판](images/03_project_approaches/pmbok8-table-2-1-focus-areas-domains-ko.png)

*PMBOK® Guide 8th Edition, Table 2-1, p. 9. 한국어 학습용 재구성.*
